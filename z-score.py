...
df = pd.read_csv(r"E:\rv\whitehatjr\python\z-test\School2.csv")
...
df = pd.read_csv(r"E:\rv\whitehatjr\python\z-test\School_1_Sample.csv")
data = df["Math_score"].tolist()
...
df = pd.read_csv(r"E:\rv\whitehatjr\python\z-test\School_3_Sample.csv")
data = df["Math_score"].tolist()
