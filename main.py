...
df = pd.read_csv(r"E:\rv\whitehatjr\python\z-test\studentMarks.csv")
...
df = pd.read_csv(r"E:\rv\whitehatjr\python\z-test\data3.csv")
data = df["Math_score"].tolist()
...
fig.add_trace(go.Scatter(x=[mean_of_sample3, mean_of_sample3], y=[
              0, 0.17], mode="lines", name="MEAN OF STUDNETS WHO GOT FUNSHEETS"))
